...
export default {
  async fetch(request, env, ctx) {
    ...
    const USERS = env.USERS ? JSON.parse(env.USERS) : {
      ...
      '1002932344799371354
      +-': { pin: '191125', role: ' Cirkle Dev | Associate Director', name: 'Appler Smith', pfp: 'https://media.discordapp.net/attachments/1433394788761342143/1433598236702019624/IMG_7285.png' }
    };
